...
#define OV7670_QVGA_WIDTH  CAM_VGA_WIDTH
#define OV7670_QVGA_HEIGHT CAM_VGA_HEIGHT
...
RET ov7670_init(DCMI_HandleTypeDef *p_hdcmi, DMA_HandleTypeDef *p_hdma_dcmi,
...
void ov7670_registerCallback(void (*cbHsync)(uint32_t h),
...
static RET ov7670_write(uint8_t regAddr, uint8_t data)
{
	...
	do
	{
		ret = HAL_I2C_Mem_Write(sp_hi2c, SLAVE_ADDR, regAddr,
